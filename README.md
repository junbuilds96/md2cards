...
4. Use a visual recipe style pack to restyle the card without replacing your Markdown, or tune theme, density, type scale, typography voice, accent, background intensity, corner radius, texture depth, mood, and export quality manually.
...
- Appearance-only visual recipes/style packs that preserve Markdown while applying polished theme, density, type, accent, texture, mood, and label combinations.
- Appearance controls for density, type scale, typography voice, accent color, background intensity, corner radius, texture depth, and visual mood.
